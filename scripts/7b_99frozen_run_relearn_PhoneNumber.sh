#!/bin/bash
#SBATCH --job-name=7b_99frozen_relearn_PhoneNumber
...
DONE_FILE="$HOME/OLMoBench/7b_99frozen_relearn_PhoneNumber_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B 99frozen Relearning Phone_Number completed at $(date)"
