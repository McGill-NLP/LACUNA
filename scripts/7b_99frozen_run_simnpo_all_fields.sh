#!/bin/bash
#SBATCH --job-name=7b_99frozen_simnpo_all_fields
...
DONE_FILE="$HOME/OLMoBench/7b_99frozen_simnpo_completed_runs.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B 99frozen SimNPO all fields completed at $(date)"
