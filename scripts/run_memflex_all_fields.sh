#!/bin/bash
#SBATCH --job-name=memflex_all_fields
...
DONE_FILE="$HOME/OLMoBench/memflex_completed_runs.txt"
touch "$DONE_FILE"
...
declare -A FIELD_MAP=(
  ["OLMo_Mask_Unlearn_MemFlex_EmailAddress_CrossField"]="Email_Address"
  ["OLMo_Mask_Unlearn_MemFlex_PhoneNumber_CrossField"]="Phone_Number"
  ["OLMo_Mask_Unlearn_MemFlex_BirthCity_CrossField"]="Birth_City"
  ["OLMo_Mask_Unlearn_MemFlex_DriversLicense_CrossField"]="Drivers_License"
)

EXPERIMENTS=(
  "OLMo_Mask_Unlearn_MemFlex_EmailAddress_CrossField"
  "OLMo_Mask_Unlearn_MemFlex_PhoneNumber_CrossField"
  "OLMo_Mask_Unlearn_MemFlex_BirthCity_CrossField"
...
echo "[ALL DONE] MemFlex all fields completed at $(date)"
