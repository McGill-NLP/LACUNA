#!/bin/bash
#SBATCH --job-name=7b_relearn_BirthCity
...
DONE_FILE="$HOME/OLMoBench/7b_relearn_BirthCity_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B Relearning Birth_City completed at $(date)"
