#!/bin/bash
#SBATCH --job-name=relearn_EmailAddress
...
DONE_FILE="$HOME/OLMoBench/relearn_EmailAddress_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] Relearning Email_Address completed at $(date)"
