#!/bin/bash
#SBATCH --job-name=relearn_mem_PhoneNumber
...
DONE_FILE="$HOME/OLMoBench/relearn_memorized_PhoneNumber_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] Memorized relearning Phone_Number completed at $(date)"
