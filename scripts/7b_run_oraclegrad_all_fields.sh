#!/bin/bash
#SBATCH --job-name=7b_oraclegrad_all_fields
...
DONE_FILE="$HOME/OLMoBench/7b_oraclegrad_completed_runs.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B OracleGrad all fields completed at $(date)"
