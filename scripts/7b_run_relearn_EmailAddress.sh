#!/bin/bash
#SBATCH --job-name=7b_relearn_EmailAddress
...
DONE_FILE="$HOME/OLMoBench/7b_relearn_EmailAddress_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B Relearning Email_Address completed at $(date)"
