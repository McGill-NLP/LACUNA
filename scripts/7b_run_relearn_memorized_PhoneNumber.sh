#!/bin/bash
#SBATCH --job-name=7b_relearn_mem_PhoneNumber
...
DONE_FILE="$HOME/OLMoBench/7b_relearn_memorized_PhoneNumber_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B Memorized relearning Phone_Number completed at $(date)"
