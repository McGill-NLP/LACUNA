#!/bin/bash
#SBATCH --job-name=7b_memflex_all_fields
...
DONE_FILE="$HOME/OLMoBench/7b_memflex_completed_runs.txt"
touch "$DONE_FILE"
...
for EXP in "${EXPERIMENTS[@]}"; do
  ...
  # grad_thresh=1e-5 (default 6e-4 yields ZERO located params on 7B — see memflex_7b_bug.md)
...
echo "[ALL DONE] 7B MemFlex all fields completed at $(date)"
