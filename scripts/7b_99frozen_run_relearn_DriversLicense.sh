#!/bin/bash
#SBATCH --job-name=7b_99frozen_relearn_DriversLicense
...
DONE_FILE="$HOME/OLMoBench/7b_99frozen_relearn_DriversLicense_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B 99frozen Relearning Drivers_License completed at $(date)"
