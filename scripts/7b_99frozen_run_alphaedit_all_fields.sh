#!/bin/bash
#SBATCH --job-name=7b_99frozen_alphaedit_all_fields
...
DONE_FILE="$HOME/OLMoBench/7b_99frozen_alphaedit_completed_runs.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B 99frozen AlphaEdit all fields completed at $(date)"
