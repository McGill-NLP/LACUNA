#!/bin/bash
#SBATCH --job-name=7b_99frozen_relearn_mem_BirthCity
...
DONE_FILE="$HOME/OLMoBench/7b_99frozen_relearn_memorized_BirthCity_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B 99frozen Memorized relearning Birth_City completed at $(date)"
