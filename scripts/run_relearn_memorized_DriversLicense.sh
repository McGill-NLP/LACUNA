#!/bin/bash
#SBATCH --job-name=relearn_mem_DriversLicense
...
DONE_FILE="$HOME/OLMoBench/relearn_memorized_DriversLicense_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] Memorized relearning Drivers_License completed at $(date)"
