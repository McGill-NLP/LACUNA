#!/bin/bash
#SBATCH --job-name=7b_relearn_mem_EmailAddress
...
DONE_FILE="$HOME/OLMoBench/7b_relearn_memorized_EmailAddress_completed.txt"
touch "$DONE_FILE"
...
echo "[ALL DONE] 7B Memorized relearning Email_Address completed at $(date)"
